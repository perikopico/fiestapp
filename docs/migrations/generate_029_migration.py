#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Script para generar la migración 029: Actualizar info_url y description desde JSON"""
...
def main():
    ...
    sql_updates = []
    sql_updates.append("-- ============================================")
    sql_updates.append("-- Migración 029: Actualizar info_url y description desde JSON")
    sql_updates.append("-- ============================================")
    ...
    for event in events:
        ...
        if update_parts:
            ...
            update_sql += f"\nWHERE title = '{title_escaped}' AND {date_condition};"
            update_sql += "\n"
